...
@app.route('/s3_service/<path:folder_path>/')
...
@app.route('/s3_service/create_folder', methods=['POST'])
def create_folder():
    try:
...
@app.route('/s3_service/search', methods=['POST'])
def search():
    try:
...
@app.route('/s3_service/upload', methods=['POST'])
def upload():
    try:
...
@app.route('/s3_service/download/<string:file_name>')
